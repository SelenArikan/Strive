                        ...
                        <div className="bg-surface-dark rounded-2xl border border-white/10 w-full max-w-2xl my-8">
                            ...
                            <form onSubmit={handleSubmit} className="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    {/* Sub Category (Saha Tipi) */}
                                    <div>
                                        <label className="block text-sm font-medium text-gray-300 mb-1">Saha Tipi *</label>
                                        <select
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-background-dark border border-white/10 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-primary"
                                            placeholder="Örn: Indoor, Outdoor, Hybrid"
                                        />
                                    </div>
                        ...
                        <table className="w-full">
                            <thead className="bg-background-dark">
                                <tr>
                                    ...
                                    <th className="text-left px-6 py-4 text-sm font-medium text-gray-400">Beden</th>
                            ...
                            <tbody className="divide-y divide-white/5">
                                {products.map((product) => (
                                    <tr key={product.id} className="hover:bg-white/5 transition-colors">
                                        ...
                                        <td className="px-6 py-4 text-gray-300">{product.size || "-"}</td>
                                        <td className="px-6 py-4">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-1">
                                                <span className="text-gray-400 text-sm">{product.media?.filter(m => m.type === "image").length || 0} görsel</span>
                                                {product.media?.some(m => m.type === "video") && (
                                                    <span className="text-primary text-sm">+ video</span>
                                                )}
                                            </div>
                                        </td>
                                        <td className="px-6 py-4">
                                            <span className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium ${product.inStock ? "bg-green-500/10 text-green-400" : "bg-red-500/10 text-red-400"}`}>
